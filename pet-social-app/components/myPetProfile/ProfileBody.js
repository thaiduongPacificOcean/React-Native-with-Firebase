...
const ProfileBody = ({petOfUser, currentUserLogin}) => {
  return (
      ...
      <View style={styles.profileContainer}>
        ...
        <View style={styles.infoPet}>
          ...
          <View style={styles.userInfo}>
            <Image source={{uri:currentUserLogin && currentUserLogin.profile_picture}}
              style={styles.userImg}
            />
            <Text style={styles.userName}>{currentUserLogin && currentUserLogin.username}</Text>
          </View>
