    ...
    <View style= {styles.container}>
      <View style={styles.commentContainer}>
            <View style={{ height: 50 , width: 50 , padding : 2 , borderColor : '#3B68E6', borderWidth: 2 ,borderRadius: 30}} >
              <Image source={{uri: video.profile_picture}} style={{ height: '100%' , width: '100%' , borderRadius: 25 ,resizeMode: 'cover'}}/>
            </View>
            <View style={styles.content}>
              <View style={{flexDirection:'row', alignItems: 'center' , alignContent: 'center'}}>
                <Text style={{fontWeight: 'bold', marginBottom: 5 , marginRight: 5, marginTop: 2}}>{video.username}</Text>
