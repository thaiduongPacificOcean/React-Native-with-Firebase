...
const ListPet = ({ currentUserLogin }) => {
    ...
    return (
      <View style={styles.cardContainer} >
        <View style={styles.cardImageContainer}>
          <Image
            source={{ uri: petOfUser.petImageUrl }}
            style={{
              width: '100%',
              height: '100%',
              resizeMode: 'cover',
        ...
        <View style={styles.cardDetailsContainer}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            <Icon name="heart" size={22} color={'grey'} />
          </View>
          <Text style={{ fontSize: 12, marginVertical: 5, color: '#111' }}>
            Loại : {petOfUser.type}
          </Text>
          <Text style={{ fontSize: 10, marginVertical: 5, color: 'grey' }}>
            Ngày sinh : {time}
          </Text>
